...
public class TheSeventhTask extends AppCompatActivity implements View.OnClickListener{

    private TextView _tvTxtQuest, _time;
    private EditText _answerQuest;
    private EditText _answerQuest2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.the_seventh_task_activity);
        ...
        _answerQuest2 = (EditText) findViewById(R.id._answerQuest2);
    ...
    public void onClick(View view){
        ...
        String _answerForQuest2 = _answerQuest2.getText().toString().trim();

        switch (view.getId()){

            case R.id._btEnterAnswer:

                if(TextUtils.isEmpty(_answerForQuest) && TextUtils.isEmpty(_answerForQuest2)){
                    Toast.makeText(getApplicationContext(), "Поле для вводу пусте", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (!_answerForQuest.equalsIgnoreCase("250") && !_answerForQuest.equalsIgnoreCase("490")){
                ...
                Intent intent = new Intent(TheSeventhTask.this, SeventhCoordinate.class);
                startActivity(intent);
                break;

            case R.id._btPrompt:

                AlertDialog.Builder builder = new AlertDialog.Builder(TheSeventhTask.this);
                ...
                builder.setPositiveButton("Так", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        point -= 3;
                        TheFirstTask.setPoint(point);
                        Toast.makeText(getApplicationContext(), "Кролів на 240 менше ніж фазанів", Toast.LENGTH_LONG).show();
                    }
                });
