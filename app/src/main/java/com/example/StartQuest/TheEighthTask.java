...
public class TheEighthTask extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.the_eighth_task_activity);
    ...
    public void onClick(View view){
        ...
        switch (view.getId()){
            ...
            case R.id._btEnterAnswer:
                ...
                if (!_answerForQuest.equalsIgnoreCase("22")){
                ...
                Intent intent = new Intent(TheEighthTask.this, EighthCoordinate.class);
                startActivity(intent);
                break;

            case R.id._btPrompt:

                AlertDialog.Builder builder = new AlertDialog.Builder(TheEighthTask.this);
                ...
                builder.setPositiveButton("Так", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        point -= 3;
                        TheFirstTask.setPoint(point);
                        Toast.makeText(getApplicationContext(), "Це двохзначне число більше 20ти і меньше 30ти", Toast.LENGTH_LONG).show();
                    }
                });
