    ...
    public void onClick(View view){
        ...
        switch (view.getId()){
            ...
            case R.id._btEnterAnswer:
                ...
                if (!_answerForQuest.equalsIgnoreCase("Інверсія")){
            ...
            case R.id._btPrompt:
                ...
                builder.setPositiveButton("Так", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        point -= 3;
                        TheFirstTask.setPoint(point);
                        Toast.makeText(getApplicationContext(), "Одна зі стилістичних фігур поетичного мовлення", Toast.LENGTH_LONG).show();
                    }
                });
