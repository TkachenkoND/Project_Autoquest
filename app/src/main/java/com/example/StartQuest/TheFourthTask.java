...
public class TheFourthTask extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.the_fourth_task_activity);
    ...
    public void onClick(View view){
        ...
        switch (view.getId()){
            ...
            case R.id._btEnterAnswer:
                ...
                if (!_answerForQuest.equalsIgnoreCase("Катамаран")){
                ...
                Intent intent = new Intent(TheFourthTask.this, FourthCoordinate.class);
                startActivity(intent);
                break;

            case R.id._btPrompt:

                AlertDialog.Builder builder = new AlertDialog.Builder(TheFourthTask.this);
                ...
                builder.setPositiveButton("Так", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        point -= 3;
                        TheFirstTask.setPoint(point);
                        Toast.makeText(getApplicationContext(), "Це вид водного транспорту)", Toast.LENGTH_LONG).show();
                    }
                });
