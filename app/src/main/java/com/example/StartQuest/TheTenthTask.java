...
public class TheTenthTask extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.the_tenth_task_activity);
    ...
    public void onClick(View view){
        ...
        switch (view.getId()){
            ...
            case R.id._btEnterAnswer:
                ...
                if (!_answerForQuest.equalsIgnoreCase("Годинник")){
                ...
                Intent intent = new Intent(TheTenthTask.this, FinalCoordinate.class);
                startActivity(intent);
                break;

            case R.id._btPrompt:

                AlertDialog.Builder builder = new AlertDialog.Builder(TheTenthTask.this);
                ...
                builder.setPositiveButton("Так", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        point -=3;
                        TheFirstTask.setPoint(point);
                        Toast.makeText(getApplicationContext(), "Цей предмет зазвичай носять на лівій руці)", Toast.LENGTH_LONG).show();
                    }
                });
