...
public class TheSixthTask extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.the_sixth_task_activity);
    ...
    public void onClick(View view){
        ...
        switch (view.getId()){
            ...
            case R.id._btEnterAnswer:
                ...
                if (!_answerForQuest.equalsIgnoreCase("0,015")){
                ...
                Intent intent = new Intent(TheSixthTask.this, SixthCoordinate.class);
                startActivity(intent);
                break;

            case R.id._btPrompt:

                AlertDialog.Builder builder = new AlertDialog.Builder(TheSixthTask.this);
                ...
                builder.setPositiveButton("Так", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        point -= 3;
                        TheFirstTask.setPoint(point);
                        Toast.makeText(getApplicationContext(), "Це число 1/64 у вигляді десяткового дробу", Toast.LENGTH_LONG).show();
                    }
                });
    ...
    public void updateTimer(){
        ...
        if(mins == 0 && seconds == 0){
            ...
            Intent intent = new Intent(TheSixthTask.this, SeventhCoordinate.class);
            startActivity(intent);
        }
